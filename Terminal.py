...
class Terminal():
    ...
    def bindKeys(self):
        ...
        self.terminal.bind('<Control-Left>', lambda event: 'break')
        self.terminal.bind('<Control-Right>', lambda event: 'break')
        self.terminal.bind('<Control-Up>', lambda event: 'break')
        self.terminal.bind('<Control-Down>', lambda event: 'break')
        self.terminal.bind('<Control-a>', lambda event: 'break')
        self.terminal.bind('<Control-c>', self.onCommandC)
        self.terminal.bind('<Control-v>', self.onCommandV)
        self.terminal.bind('<Control-x>', self.onCommandC)
        self.terminal.bind('<Control-minus>', self.printAssign)
