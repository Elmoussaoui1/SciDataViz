...
class mainApp():
    ...
    def bindKeys(self):
        ...
        self.root.bind("<Control-y>", self.removeCurrentTab)
        self.root.bind("<Control-n>", lambda e: self.addNewTab())
        self.root.bind("<Control-o>", lambda e: self.addNewTab(filedialog.askopenfilename()))
        self.root.bind("<Control-s>", lambda e: self.save(e))
